...
google.maps.event.addDomListener(window, 'load', initialize);
  ...
  <body>
	...
	<div>
	<input type="checkbox" id="arsenic" checked="checked"><img src="arsenic.png">Arsenic</input>
	<input type="checkbox" id="fluoride"><img src="fluoride.png">Fluoride</input>
	<input type="checkbox" id="iron"><img src="iron.png">Iron</input>
	<input type="checkbox" id="nitrate"><img src="nitrate.png">Nitrate</input>
	<input type="checkbox" id="salinity"><img src="salinity.png">Salinity</input>
	</div>  
